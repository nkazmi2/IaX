...
np.savetxt(folder +'/'+ title + '435555.txt', np.c_[xcoord[cut435555[1]]+.5 ,ycoord[cut435555[1]]]+.5,fmt = "%1.2f")
np.savetxt(folder +'/'+ title + '625814.txt', np.c_[xcoord[cut625814[1]]+.5 ,ycoord[cut625814[1]]]+.5,fmt = "%1.2f")
################################################### 
