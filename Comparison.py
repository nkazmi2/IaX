...
###########################################################################
c1plt.errorbar(np.subtract(f435f555_4[0],   f435f555_4[1]),   f435f555_4[1], 
              f435f555_4[2],   f435f555_4[3], fmt=None, ecolor="b", marker=None, mew=0 )
c1plt.scatter(np.subtract(f435f555_4[0],   f435f555_4[1]),   f435f555_4[1],   
              label = 'S/N 4, Radius ' + str(radius),  c="w",marker='D')
c1plt.errorbar(np.subtract(f435f555_5[0],   f435f555_5[1]),   f435f555_5[1], 
              f435f555_5[2],   f435f555_5[3], fmt=None, marker=None, mew=0 )
c1plt.scatter(np.subtract(f435f555_5[0],   f435f555_5[1]),   f435f555_5[1],
              label = 'S/N 5, Radius ' + str(radius),  c="b",marker='D')
#c1plt.errorbar(np.subtract(f435f555_6[0],   f435f555_6[1]),   f435f555_6[1], 
#              f435f555_6[2],   f435f555_6[3], fmt=None, ecolor="b", marker=None, mew=0 )
#c1plt.scatter(np.subtract(f435f555_6[0],   f435f555_6[1]),   f435f555_6[1],   
#              label = 'S/N 6, Radius ' + radius,  c="w",marker='D')
#c1plt.errorbar(np.subtract(f435f555_7[0],   f435f555_7[1]),   f435f555_7[1], 
#              f435f555_7[2],   f435f555_7[3], fmt=None, ecolor="b", marker=None, mew=0 )
