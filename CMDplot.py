...
for sample in izip(np.subtract(f435f555_4[0][0],f435f555_4[0][1]), f435f555_4[0][1]):
    closestD = -1 
    closestIdx = -1
    for IdX , val in enumerate(izip(np.subtract(F435W[age79],F555W[age79]),F555W[age79])):
...
func_vals = np.c_[np.subtract(F435W[age79],F555W[age79]),F555W[age79]]

comp_vals = func_vals[ClosInd]
print "Chi^2 of 10^7.74"
...
########################################################################### 
figname = title + '_' + 'Z' + name[1:-7]+ 'slope.png'
